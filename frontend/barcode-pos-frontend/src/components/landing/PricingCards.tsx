...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'Raporlama & Excel', included: false },
      { text: 'Yedekleme', included: false },
      { text: 'Destek', included: false },
    ],
    cta: 'Ücretsiz Başla',
    href: '/kayit',
  },
  ...
  },
  {
    ...
    features: [
      { text: 'Sınırsız ürün', included: true },
      { text: '1 kullanıcı', included: true },
      { text: 'Tüm Profesyonel özellikleri', included: true },
      { text: 'Çoklu şube desteği', included: true },
      { text: 'Öncelikli destek', included: true },
      { text: 'Özel geliştirme', included: true },
      { text: 'Eğitim & kurulum desteği', included: true },
